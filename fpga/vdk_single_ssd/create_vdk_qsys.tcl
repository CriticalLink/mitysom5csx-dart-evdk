# qsys scripting (.tcl) file for vdk_single_ssd
package require -exact qsys 16.0

create_system {vdk_single_ssd}
...
set OUTPUT_WIDTH  1280
set OUTPUT_HEIGHT 720
set CAM_WIDTH  2592
set CAM_HEIGHT 1944 
set OVERLAY_RAM_ADDR 0x20000000
set CAM1_RAM_ADDR 0x23000000
...
add_instance hps_0 altera_hps 16.0
add_instance vid_pll altera_pll 16.0
add_instance sysid_qsys altera_avalon_sysid_qsys 16.0
add_instance ugpio altera_avalon_pio 16.0
add_instance cam1_input bcon_input 1.1
add_instance cam1_pll_reconfig altera_pll_reconfig 16.0
add_instance cam1_cvi alt_vip_cl_cvi 16.0
add_instance cam1_wr alt_vip_cl_vfb 16.0
add_instance cam1_rd alt_vip_cl_vfb 16.0
add_instance overlay_rd alt_vip_cl_vfb 16.0
add_instance mixer alt_vip_cl_mixer 16.0
add_instance cvo alt_vip_cl_cvo 16.0
add_instance vid_out_clk altera_clock_bridge 16.0
...
set_instance_parameter_value cam1_cvi {H_ACTIVE_PIXELS_F0} $CAM_WIDTH
set_instance_parameter_value cam1_cvi {V_ACTIVE_LINES_F0} $CAM_HEIGHT
...
set_instance_parameter_value cam1_rd {MAX_WIDTH} $CAM_WIDTH
set_instance_parameter_value cam1_rd {MAX_HEIGHT} $CAM_HEIGHT
set_instance_parameter_value cam1_rd {CLOCKS_ARE_SEPARATE} {1}
set_instance_parameter_value cam1_rd {MEM_PORT_WIDTH} {64}
set_instance_parameter_value cam1_rd {MEM_BASE_ADDR} $CAM1_RAM_ADDR
...
set_instance_parameter_value cam1_wr {MAX_WIDTH} $CAM_WIDTH
set_instance_parameter_value cam1_wr {MAX_HEIGHT} $CAM_HEIGHT
set_instance_parameter_value cam1_wr {CLOCKS_ARE_SEPARATE} {1}
set_instance_parameter_value cam1_wr {MEM_PORT_WIDTH} {64}
set_instance_parameter_value cam1_wr {MEM_BASE_ADDR} $CAM1_RAM_ADDR
...
set_instance_parameter_value cvo {H_ACTIVE_PIXELS} $OUTPUT_WIDTH
set_instance_parameter_value cvo {V_ACTIVE_LINES} $OUTPUT_HEIGHT
set_instance_parameter_value cvo {ACCEPT_COLOURS_IN_SEQ} {0}
set_instance_parameter_value cvo {FIFO_DEPTH} $OUTPUT_WIDTH
...
set_instance_parameter_value mixer {MAX_WIDTH} $OUTPUT_WIDTH
set_instance_parameter_value mixer {MAX_HEIGHT} $OUTPUT_HEIGHT
...
set_instance_parameter_value mixer {ALPHA_ENABLE} {0}
...
set_instance_parameter_value overlay_rd {MAX_WIDTH} $OUTPUT_WIDTH
set_instance_parameter_value overlay_rd {MAX_HEIGHT} $OUTPUT_HEIGHT
set_instance_parameter_value overlay_rd {CLOCKS_ARE_SEPARATE} {1}
set_instance_parameter_value overlay_rd {MEM_PORT_WIDTH} {64}
set_instance_parameter_value overlay_rd {MEM_BASE_ADDR} $OVERLAY_RAM_ADDR
...
set_instance_parameter_value vid_pll {gui_device_speed_grade} {1}
...
save_system {vdk_single_ssd.qsys}
