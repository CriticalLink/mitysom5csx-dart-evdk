...
set_false_path -to [get_ports {CAM2_CC*}]
...
#set_false_path -from * -to {dev_5cs:u0|bcon_input:cam1_input|s_fifo_data_full_reg}

#set_false_path -from {dev_5cs:u0|bcon_input:cam2_input|s_srst_reg} -to *
#set_false_path -from {dev_5cs:u0|bcon_input:cam2_input|s_pll_rst_reg} -to *
#set_false_path -from * -to {dev_5cs:u0|bcon_input:cam2_input|s_fifo_data_full_reg}
