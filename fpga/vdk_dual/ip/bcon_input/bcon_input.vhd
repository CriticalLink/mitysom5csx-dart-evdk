...
entity bcon_input is
	...
	(
		...
		vid_data           : out  std_logic_vector(g_vid_data_length-1 downto 0); 
		...
		debug_fval		: out std_logic;
		debug_lval		: out std_logic;
		debug_pll_lock		: out std_logic;
		debug_sync_lock		: out std_logic;
...
begin
	...
	VID_DATA_GEN_COLOR : if (g_vid_data_length = 24) generate
		...
		vid_data(15 downto 8)  <= s_databits(15 downto 8);
		vid_data(7 downto 0)   <= s_databits(23 downto 16);
	end generate;	

	VID_DATA_GEN_MONO : if (g_vid_data_length = 8) generate
		vid_data(7 downto 0) <= s_databits(7 downto 0);
	end generate;	
	...
	debug_fval <= s_x_fval;
	debug_lval <= s_x_lval;
	debug_pll_lock <= s_x_locked;
	debug_sync_lock <= s_xclk_locked_reg;
